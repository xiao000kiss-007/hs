<template>
  <div class="editcustomer">
    <el-row class="content">
      <el-col :xs="{span:20,offset:2}" :sm="{span:10,offset:6}">
        <h3>
          <i class="el-icon-edit-outline"> 修改客户信息</i>
        </h3>
        <el-form :model="form" ref="form" label-width="130px" size="small">
          <el-form-item label="公司名称">
            <el-col :span="4">
              <el-switch v-model="value[0]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="联系人">
            <el-col :span="4">
              <el-switch v-model="value[1]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="电话">
            <el-col :span="4">
              <el-switch v-model="value[2]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="社会统一信用代码">
            <el-col :span="4">
              <el-switch v-model="value[3]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="国税密码">
            <el-col :span="4">
              <el-switch v-model="value[4]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="地税密码">
            <el-col :span="4">
              <el-switch v-model="value[5]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="网申注册码">
            <el-col :span="4">
              <el-switch v-model="value[6]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="法人">
            <el-col :span="4">
              <el-switch v-model="value[7]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="法人身份证">
            <el-col :span="4">
              <el-switch v-model="value[8]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="地址">
            <el-col :span="4">
              <el-switch v-model="value[9]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="业务类型">
            <el-col :span="4">
              <el-switch v-model="value[10]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="社保账号">
            <el-col :span="4">
              <el-switch v-model="value[11]"></el-switch>
            </el-col>
            <el-col :span="20">
          ...
          <el-form-item label="社保密码">
            <el-col :span="4">
              <el-switch v-model="value[12]"></el-switch>
            </el-col>
            <el-col :span="20">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$http.put(this.GLOBAL.baseUrl + "/api/customer", obj).then(
        res => {
          if (res.data.success) {
            this.$message({
              // 添加成功，显示提示语
